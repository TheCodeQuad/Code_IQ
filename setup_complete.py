#!/usr/bin/env python3
"""
Setup script to create CKG API directories and route files
"""
import os
import sys

def setup_ckg_routes():
    """Create all required directories and files for CKG routes"""
    ...
    try:
        ...
        print(f"✓ Created directory: {os.path.join(base_path, 'stats')}")
        print(f"✓ Created directory: {os.path.join(base_path, 'subgraph')}")
