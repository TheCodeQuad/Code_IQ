...
export default function ResultsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#fef5fb]">
      {/* Header/Navbar */}
      <header className="border-b border-purple-200 bg-white backdrop-blur-md sticky top-0 z-50">
        <div className="max-w-[1600px] mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            {/* Right section */}
            <Button className="bg-black text-white hover:bg-purple-900">
      ...
      <div className="border-b border-purple-200 bg-[#fef5fb]">
        <div className="max-w-[1600px] mx-auto px-6 py-3">
          <nav className="inline-flex items-center gap-1 p-1.5 bg-purple-100 rounded-lg">
            {navItems.map((item) => {
