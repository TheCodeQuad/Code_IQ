...
export function RepositoryToDAG({
  ...
  return (
    <div className={`fixed inset-0 flex items-center justify-center bg-[#fef5fb] overflow-hidden z-[100] transition-opacity duration-300 ${logFadeOut ? 'opacity-0 pointer-events-none' : 'opacity-100'}`}>
      <div
      ...
      >
        <div className="flex-1 max-w-2xl" style={{ fontFamily: "Arial, Helvetica, sans-serif" }}>
          ...
          <div className="terminal-window overflow-hidden border border-border bg-card rounded-lg flex flex-col" style={{ fontFamily: "Consolas, 'Courier New', monospace" }}>
            <div className="terminal-header flex items-center px-4 py-2 border-b border-border bg-muted/50">
              ...
              <span className="ml-3 text-xs text-muted-foreground">repository-scanner</span>
