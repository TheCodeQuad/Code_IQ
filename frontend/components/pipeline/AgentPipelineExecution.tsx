...
function TerminalLogs({ iteration, pipelineState, filePath }: { iteration: AgenticIteration | null; pipelineState: PipelineState; filePath: string }) {
  ...
  return (
    <aside className="bg-[#0f111a] text-gray-300 p-6 rounded-3xl w-full font-mono text-[13px] shadow-[0_20px_50px_rgba(0,0,0,0.3)] relative overflow-hidden flex flex-col flex-1 border border-gray-800 hover:scale-[1.01] transition-transform duration-500 z-10">
...
export function AgentPipelineExecution({ pipelineState, repoId, selectedComponent }: AgentPipelineExecutionProps) {
  ...
  return (
    <div className="w-full h-[calc(100vh-56px)] max-w-[1550px] mx-auto p-4 md:p-6 lg:p-8 bg-transparent overflow-hidden relative font-sans flex flex-col">
      ...
      <div className="relative z-10 flex flex-col h-full items-center">
        ...
        <div className="flex flex-col xl:flex-row gap-6 lg:gap-8 w-full items-start flex-1 min-h-0 pt-2">
          ...
          <div className="flex flex-col gap-6 w-full xl:w-[380px] shrink-0 z-20 h-full min-h-0">
             
             {/* Info Card 1: Details */}
             <div className="bg-white dark:bg-gray-800 rounded-3xl p-6 shadow-[12px_12px_24px_rgba(0,0,0,0.1),-12px_-12px_24px_rgba(255,255,255,0.8)] dark:shadow-[12px_12px_24px_rgba(0,0,0,0.3),-12px_-12px_24px_rgba(255,255,255,0.1)] ring-1 ring-black/5 dark:ring-white/10 relative overflow-hidden group hover:scale-[1.01] transition-transform duration-500 shrink-0">
                ...
                <p className="text-[11px] font-bold tracking-widest text-indigo-500 dark:text-indigo-400 uppercase mb-4 pl-1">Analyzing Target</p>
                
                <h3 className="font-extrabold text-xl text-gray-900 dark:text-gray-100 mb-6 flex items-center gap-3">
                  <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent truncate block" title={componentName}>{componentName}</span>
                </h3>

                <div className="space-y-4">
                  <div className="flex items-center justify-between border-b border-gray-100 dark:border-gray-700/50 pb-3">
                    <span className="text-sm font-medium text-gray-500 dark:text-gray-400">Component Type</span>
                    <div className="flex items-center gap-1.5 text-sm font-bold text-gray-800 dark:text-gray-200">
                      <div className="w-5 h-5 rounded bg-emerald-100 dark:bg-emerald-900/40 flex items-center justify-center text-emerald-600 dark:text-emerald-400 text-xs shadow-sm shadow-emerald-500/20">
                  ...
                  <div className="border-b border-gray-100 dark:border-gray-700/50 pb-3">
                    <span className="text-sm font-medium text-gray-500 dark:text-gray-400 block mb-2">File Path</span>
                    <span className="font-mono text-[11px] bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-300 px-2 py-1.5 rounded-lg border border-gray-200 dark:border-gray-700 w-full block break-all leading-relaxed" title={filePath}>
                      {filePath}
                    </span>
                  </div>
                  ...
                  <div className="pt-2">
                    <div className="flex justify-between items-end mb-1.5">
                      <span className="text-xs font-semibold text-gray-600 dark:text-gray-400">Total Progress</span>
                      <span className="text-xs font-bold text-emerald-600 dark:text-emerald-500 bg-emerald-100/50 dark:bg-emerald-900/30 px-2 py-0.5 rounded text-emerald-700 dark:text-emerald-400">{completedCount}/{totalCount} components</span>
                    </div>
                    <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2 shadow-inner">
                      <div className="bg-gradient-to-r from-emerald-400 to-green-500 h-2 rounded-full shadow-[0_0_8px_rgba(16,185,129,0.6)] transition-all duration-1000" style={{ width: `${progressPct}%` }}></div>
                    </div>
                  </div>
                </div>
             </div>
          ...
          <div ref={wrapperRef} className="flex-1 w-full relative h-[650px] xl:h-full bg-white/40 dark:bg-gray-800/40 rounded-[3rem] border border-white/60 dark:border-gray-700/60 shadow-[inset_0_4px_24px_rgba(0,0,0,0.02)] overflow-hidden flex items-center justify-center min-h-[400px]">
            {/* Animated Grid Background */}
            <div className="absolute inset-0 opacity-[0.12] pointer-events-none rounded-[3rem] overflow-hidden">
              <div
                className="absolute inset-0 bg-gradient-to-br from-transparent via-gray-300 dark:via-gray-600 to-transparent"
                style={{
                  backgroundImage: `linear-gradient(rgba(156, 163, 175, 0.4) 1px, transparent 1px), linear-gradient(90deg, rgba(156, 163, 175, 0.4) 1px, transparent 1px)`,
                  backgroundSize: "40px 40px",
                  animation: "gridMove 20s linear infinite",
                }}
              />
              <style>{`@keyframes gridMove { 0% { transform: translate(0, 0); } 100% { transform: translate(40px, 40px); } }`}</style>
            </div>
            ...
            >
              <div className="relative w-full h-full">
                ...
                <div className="group absolute top-[650px] left-[360px] w-[280px] bg-white dark:bg-gray-800 rounded-full py-4 px-6 shadow-[12px_12px_24px_rgba(0,0,0,0.15),-12px_-12px_24px_rgba(255,255,255,0.9)] dark:shadow-[12px_12px_24px_rgba(0,0,0,0.3),-12px_-12px_24px_rgba(255,255,255,0.1)] transition-all duration-500 hover:shadow-[20px_20px_40px_rgba(0,0,0,0.2),-20px_-20px_40px_rgba(255,255,255,1)] hover:scale-105 hover:-translate-y-2 z-20 flex items-center justify-center gap-3">
                ...
                {isPipelineCompleted && (
                  <div className="absolute bottom-[20px] right-[-100px] flex gap-4 z-40 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md px-6 py-4 rounded-full shadow-2xl border border-gray-200 dark:border-gray-700">
                    ...
                    <Link href={`/dashboard/analysis/${repoId}/results`}>
                      <Button className="bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white rounded-full px-6 py-5 text-[15px] font-semibold shadow-[0_6px_24px_rgba(16,185,129,0.4)] hover:shadow-[0_10px_32px_rgba(16,185,129,0.6)] transition-all hover:scale-105">
                        View Results
