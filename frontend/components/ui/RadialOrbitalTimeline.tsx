      ...
      <div className="relative w-full max-w-7xl h-[650px] flex items-center rounded-[40px] md:rounded-[100px] overflow-visible mx-auto"
        ...
        <div className="w-full h-full grid grid-cols-1 md:grid-cols-2 z-10" ref={containerRef} onClick={handleContainerClick}>
          ...
          <div className="relative w-full h-full flex items-center justify-center">
            ...
            >
              {/* Central Core */}
              <div className="absolute w-16 h-16 rounded-full bg-emerald-50 flex items-center justify-center z-10 shadow-sm border border-emerald-100">
              ...
              <div className="absolute w-[440px] h-[440px] rounded-full border border-black/10 border-dashed" />
              <div className="absolute w-[300px] h-[300px] rounded-full border border-black/5" />
